...
pub inline fn send(self: *Duplex, pl: ClientPayload) !void {
...
pub inline fn recieve(self: *Duplex, pl: *ServerPayload) !void {
    try self.suharyk_duplex.recieve(pl);
}

pub inline fn freePacket(self: *Duplex, p: ServerPayload) void {
